...
glib::wrapper! {
    #[doc(alias = "AdwCarouselIndicatorDots")]
...
impl CarouselIndicatorDots {
    ...
    /// Creates a new builder-pattern struct instance to construct [`CarouselIndicatorDots`] objects.
    ///
    /// This method returns an instance of [`CarouselIndicatorDotsBuilder`](crate::builders::CarouselIndicatorDotsBuilder) which can be used to create [`CarouselIndicatorDots`] objects.
    pub fn builder() -> CarouselIndicatorDotsBuilder {
        CarouselIndicatorDotsBuilder::new()
    }
    ...
    pub fn carousel(&self) -> Option<Carousel> {
        unsafe {
            from_glib_none(ffi::adw_carousel_indicator_dots_get_carousel(
                self.to_glib_none().0,
            ))
        }
    }

    #[doc(alias = "adw_carousel_indicator_dots_set_carousel")]
    pub fn set_carousel(&self, carousel: Option<&Carousel>) {
        unsafe {
            ffi::adw_carousel_indicator_dots_set_carousel(
                self.to_glib_none().0,
...
impl CarouselIndicatorDotsBuilder {
    ...
    pub fn carousel(self, carousel: &Carousel) -> Self {
        Self {
            builder: self.builder.property("carousel", carousel.clone()),
        }
    }
