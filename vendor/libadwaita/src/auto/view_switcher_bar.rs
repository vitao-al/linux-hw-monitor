...
glib::wrapper! {
    ...
    match fn {
        type_ => || ffi::adw_view_switcher_bar_get_type(),
    }
}
...
impl ViewSwitcherBar {
    ...
    #[doc(alias = "reveal")]
    pub fn connect_reveal_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
...
pub struct ViewSwitcherBarBuilder {
    builder: glib::object::ObjectBuilder<'static, ViewSwitcherBar>,
}
...
impl ViewSwitcherBarBuilder {
    ...
    pub fn reveal(self, reveal: bool) -> Self {
        Self {
            builder: self.builder.property("reveal", reveal),
        }
    }
