...
impl CarouselIndicatorLines {
    ...
    pub fn builder() -> CarouselIndicatorLinesBuilder {
        CarouselIndicatorLinesBuilder::new()
    }
...
impl Default for CarouselIndicatorLines {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct CarouselIndicatorLinesBuilder {
    builder: glib::object::ObjectBuilder<'static, CarouselIndicatorLines>,
}

impl CarouselIndicatorLinesBuilder {
    fn new() -> Self {
        Self {
